...
namespace file{
    ...
    int fdtable::createFile(int id, InodeType type, std::string name) {
    ...
    int fdtable::deleteFile(std::string name) {
    ...
    int fdtable::openFile(std::string name, int flag, int pos) {
    ...
    int fdtable::openNewFile(std::string Directory, int flag, int pos) {
    ...
    int fdtable::switchFile(int idx) {
        if(idx >= (int) FCB.size()){
